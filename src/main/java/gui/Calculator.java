		...
		if ("=".contains(value)) {
			...
			switch (operator){
				case "+":
					...
					displayText.setText(String.valueOf(resultado1));
					resultado1 = 0;
					number1 = "";
					number2 = "";
					operator = null;
				...
				case "-":
					...
					displayText.setText(String.valueOf(resultado2));
					resultado2 = 0;
					number1 = "";
					number2 = "";
					operator = null;
				...
				case "*":
					...
					displayText.setText(String.valueOf(resultado3));
					resultado3 = 0;
					number1 = "";
					number2 = "";
					operator = null;
				...
				case "/":
					...
					displayText.setText(String.valueOf(resultado4));
					resultado4 = 0;
					number1 = "";
					number2 = "";
					operator = null;
